...
<div class="login <?php echo $this->pageclass_sfx?>">
	...
	<div class="hs_users_divider hs_left">
		<div class="hs_inner">
			...
			<h3><?php echo JText::_('COM_HS_USERS_VIEW_LOGIN_DEFAULT_TITLE_LABEL'); ?></h3>
			<div class="hs_desc">
				<?php echo JText::_('COM_HS_USERS_VIEW_LOGIN_DEFAULT_TITLE_DESC'); ?>
			</div>				
	...
	<div class="hs_users_divider hs_right">
		<div class="hs_inner">
			<h3><?php echo JText::_('COM_HS_USERS_VIEW_LOGIN_SOCIALS_TITLE_LABEL'); ?></h3>
			<div class="hs_desc">
				<?php echo JText::_('COM_HS_USERS_VIEW_LOGIN_SOCIALS_TITLE_DESC'); ?>
			</div>				
